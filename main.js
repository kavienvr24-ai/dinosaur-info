const dinosaursData = [
    ...
    { name: "Ankylosaurus", type: "herbivore", sub: "Armored Tank", size: "Medium", era: "Late Cretaceous", desc: "Encased completely in thick bony armor plating, sporting a dense bone tail-club built to shatter bone.", img: "images/ankylosaurus.webp" },
    ...
    { name: "Apatosaurus", type: "herbivore", sub: "Thick Sauropod", size: "Giant", era: "Late Jurassic", desc: "A massively built, heavier sauropod than Diplodocus, demanding quiet settings and wide grazing plains.", img: "images/apatosaurus.webp" },
    ...
    { name: "Gallimimus", type: "herbivore", sub: "Flocking Ornithomimid", size: "Small", era: "Late Cretaceous", desc: "Fast-moving, completely harmless herd animal that thrives brilliantly inside open truck or gyro tours.", img: "images/gallimimus.webp" },
    { name: "Pachycephalosaurus", type: "herbivore", sub: "Bone-Headed Ram", size: "Small", era: "Late Cretaceous", desc: "Features a thick skull dome used for high-impact combat. Prone to fracturing fences when agitated.", img: "images/pachycephalosaurus.jpeg" },
    { name: "Nasutoceratops", type: "herbivore", sub: "Bull-Horned Face", size: "Small", era: "Late Cretaceous", desc: "A compact ceratopsian sporting long curved horns that heavily resemble modern cattle configurations.", img: "images/nasutoceratops.webp" },
    ...
    // --- FLYING REPTILES ---
    { name: "Pteranodon", type: "flying", sub: "Classic Flyer", size: "Medium", era: "Late Cretaceous", desc: "The flagship flying reptile of InGen. Requires fully enclosed Aviary domes and specialized fish feeders.", img: "images/pteranodon.webp" },
    { name: "Dimorphodon", type: "flying", sub: "Pug-Faced Flyer", size: "Small", era: "Early Jurassic", desc: "A small, ancient flying reptile featuring a disproportionately large, heavy skull build and sharp teeth.", img: "images/dimorphodon.jpeg" },
    ...
    // --- MARINE REPTILES ---
    { name: "Mosasaurus", type: "marine", sub: "Apex Deep Sea Titan", size: "Giant", era: "Late Cretaceous", desc: "The ultimate massive star of the Lagoon ecosystem, consuming entire sharks whole from custom feeding cranes.", img: "images/mosasaurus.jpeg" },
    ...
    { name: "Tylosaurus", type: "marine", sub: "Giant Sea Predator", size: "Large", era: "Late Cretaceous", desc: "A close, highly aggressive relative of Mosasaurus with a hardened, bone-crushing battering ram snout.", img: "images/tylosaurus.webp" },
